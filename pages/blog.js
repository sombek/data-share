                ...
                <section className="py-20">
                    <div className="container">
                        ...
                        <div className="flex flex-wrap -mx-3">
                            <div
                                ...
                                <p className="text-blueGray-400 leading-loose">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Sed luctus eget justo et iaculis.</p>
                            </div>
                            <div
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <p className="mt-6 text-sm text-blue-400">
                                        <Link href="/blog-2">
                                            <a>
                                                <span
                                                    className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Analytics</span>
                                            </a>
                                        </Link>
                                        <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                    </p>
                                ...
                                <h3 className="my-2 text-2xl font-bold font-heading">
                                    <Link href="/blog-single">
                                        <a className="hover:text-blue-500">The Next Big Challenge for Content
                                            Marketer</a>
                                    </Link>
                                </h3>
                                <p className="text-blueGray-400 leading-loose">Aenean tempus orci eu est ultrices
                                    hendrerit. Fusce suscipit, leo a semper venenatis, felis urna pulvinar nibh, vitae
                                    porta erat risus sed mauris. Vestibulum vehicula leo eget libero eleifend.</p>
                            </div>
                            <div
                                className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5"
                                data-wow-delay=".1s">
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                                        <a>
                                            <span
                                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Company</span>
                                        </a>
                                    </Link>
                                    <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                </p>
                            ...
                            <div
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                                        <a>
                                            <span
                                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Target</span>
                                        </a>
                                    </Link>
                                    <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                </p>
                            ...
                            <div
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                                        <a>
                                            <span
                                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Layers</span>
                                        </a>
                                    </Link>
                                    <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                </p>
                            ...
                            <div
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                                        <a>
                                            <span
                                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Consultancy</span>
                                        </a>
                                    </Link>
                                    <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                </p>
                            ...
                            <div
                                ...
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                                        <a>
                                            <span
                                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl mr-3">Digital</span>
                                        </a>
                                    </Link>
                                    <span className="text-blueGray-400 text-xs">24 Jan, 2021</span>
                                </p>
                        ...
                        <div className="text-center">
                            <Link href="/blog-2">
                                <a className="hover-up-5 inline-block py-4 px-8 text-xs text-white font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded">Show
                                    all posts</a>
                            </Link>
                        </div>
                    </div>
