                    ...
                    <div className="container">
                        <div className="max-w-lg mx-auto mb-12 text-center">
                            <span
                                ...
                                data-wow-delay=".1s">Our Team Leader</span>
                            ...
                            <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn animated"
                               data-wow-delay=".1s">Our Customers Very Happy With Our Services.</p>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="w-full md:w-1/2 py-5 md:px-5">
                                <div
                                    ...
                                    <p className="leading-loose text-blueGray-400 mb-5">Donec consequat tortor risus, at
                ...
                <section className="pt-20">
                    <div className="container text-center">
                        <div className="max-w-lg mx-auto mb-12">
                            <span
                                className="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl wow animate__animated animate__fadeIn animated"
                                data-wow-delay=".1s">Our Team</span>
                            <h2 className="text-3xl md:text-4xl mt-2 mb-4 font-bold font-heading wow animate__animated animate__fadeIn animated"
                                data-wow-delay=".3s">
                                Our Awesome <br/>
                            ...
                            <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn animated"
                               data-wow-delay=".1s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus
                        ...
                        <div className="flex flex-wrap -mx-3">
                            <div
                                ...
                                data-wow-delay=".4s">
                                <img className="h-64 w-64 mx-auto rounded object-cover object-top"
