    ...
    return (
        <>
            <Layout>
                        ...
                        <div className="flex flex-wrap mb-24">
                            ...
                            <div className="w-full lg:w-1/2 lg:pl-24 my-auto">
                                ...
                                <h2 className="my-4 text-4xl font-bold font-heading wow animate__animated animate__fadeIn"
                                    ...
                                    urna. Nunc at arcu non ipsum auctor lacinia quis quis mi.</h2>
                                <p className="mb-1 text-lg">
                                    <strong className="text-blue-500 wow animate__animated animate__fadeIn"
                                            data-wow-delay=".4s">Alice Bradley</strong>
                                </p>
                                <p className="text-gray-500 text-xs wow animate__animated animate__fadeIn"
                                   data-wow-delay=".5s">CEO, Co Founders</p>
                            </div>
                        </div>
                ...
                <section className="pt-20 pb-12 xl:bg-contain bg-top bg-no-repeat"
