                ...
                <section className="pt-12 pb-20 lg:bg-contain bg-top bg-no-repeat"
                    ...
                    <div className="container">
                        ...
                        <div className="flex flex-wrap justify-between -mx-3 mb-12">
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 wow animate__animated animate__fadeIn"
                                 data-wow-delay=".1s">
                                        ...
                                        <Disclosure as="div"
                                            ...
                                            {({open}) => (
                                                <>
                                                    ...
                                                    <Disclosure.Panel className="text-gray-700 text-sm mt-2">Since 2007
                                                        we have been a visionary and a reliable software design
                                                        engineering partner for world-class brands. We are a boutique
                                                        digital transformation consultancy. Id pro doctus mediocrem
                                                        erroribus, diam nostro sed cu. Ea pri graeco tritani partiendo.
                                                        Omittantur No tale choro fastidii his, pri cu epicuri perpetua.
                                        ...
                                        <Disclosure as="div"
                                            ...
                                            {({open}) => (
                                                <>
                                                    ...
                                                    <Disclosure.Panel className="text-gray-700 text-sm mt-2">Id pro
                                                        ...
                                                        quaestio mea ex. Ex illum officiis id. Contrary to popular
                                                        belief, Lorem Ipsum is not simply random text. It has roots in a
                                                        piece of classical Latin literature</Disclosure.Panel>
                                                </>
                                            )}
                                        </Disclosure>
                                        <Disclosure as="div"
                                        ...
                                        <Disclosure as="div"
                                            ...
                                            {({open}) => (
                                                <>
                                                    ...
                                                    <Disclosure.Panel className="text-gray-700 text-sm mt-2">Contrary to
                                                        popular belief, Lorem Ipsum is not simply random text. It has
                                                        roots in a piece of classical Latin literature Id pro doctus
                                                        ...
                                                        perpetua. Enim dictas omittantur et duo, vocent lucilius
                                                        quaestio mea ex. Ex illum officiis id.</Disclosure.Panel>
                                                </>
                                            )}
                                        </Disclosure>
                                        <Disclosure as="div"
                                        ...
                                        <Disclosure as="div"
                                            ...
                                            {({open}) => (
                                                <>
                                                    ...
                                                    <Disclosure.Panel className="text-gray-700 text-sm mt-2">Contrary to
                                                        popular belief, Lorem Ipsum is not simply random text. It has
                                                        roots in a piece of classical Latin literatureId pro doctus
                                                        mediocrem erroribus, diam nostro sed cu. Ea pri graeco tritani
                                                        partiendo. Omittantur No tale choro fastidii his, pri cu epicuri
                                                        perpetua. Enim dictas omittantur et duo, vocent lucilius
                                                        quaestio mea ex. Ex illum officiis id.</Disclosure.Panel>
