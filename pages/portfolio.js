                ...
                <section className="py-12 md:py-20">
                    <div className="container">
                        <div className="max-w-lg mx-auto mb-12 text-center">
                            ...
                            <h2 className="text-3xl md:text-4xl mt-2 mb-4 font-bold font-heading wow animate__animated animate__fadeIn animated"
                                data-wow-delay=".3s">
                                Check Out <br/>
                                Our <span className="text-blue-500">Latest</span> Project
                            </h2>
                            <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn animated"
                               data-wow-delay=".5s">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6 lg:mb-0">
                            ...
                            <div
                                ...
                                data-wow-delay=".6s">
                                <img className="lg:h-128 w-full object-cover rounded"
                                ...
                                <div className="absolute text-center bg-white rounded card-label-center px-4 py-12">
                                    ...
                                    <div className="w-full flex place-content-cente">
                                        <p className="font-sans text-center ext-white mt-5 mb-6">Lorem ipsum, dolor sit
                                            amet consectetur adipisicing elit. Sequi eveniet rem fugiat deserunt
                                            molestias.</p>
                                    </div>
                                    <Link href="/blog-single">
                                        <a className="tracking-wide hover-up-2 inline-block px-4 py-3 text-xs font-semibold leading-none bg-blue-400 hover:bg-blue-500 text-white rounded">View
                                            details</a>
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div
                                ...
                                data-wow-delay=".1s">
                                <img className="h-128 w-full object-cover rounded"
                                     src="/assets/imgs/placeholders/img-9.jpg" alt="Monst"/>
                                <div className="absolute text-center bg-white rounded card-label-center px-4 py-12">
                                    <div className="w-full flex place-content-center">
