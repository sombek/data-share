...
function Home() {
    return (
        <>
            <Layout>
                <section className="xl:bg-contain bg-top bg-no-repeat -mt-24 pt-24"
                    ...
                    <div className="relative max-w-6xl mt-16 md:mt-8 mb-8 mx-auto">
                        ...
                        <div className="absolute" style={{top: "9%", left: "14%", width: "72%", height: "66%"}}>
                            <img className="jump rounded wow animate__animated animate__fadeIn"
                                 src="/assets/imgs/placeholders/dashboard.png" alt="Monst"/>
                        </div>
                    </div>
                    <div className="container px-4 mx-auto">
                            ...
                            <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                                <div
                                    ...
                                    <div>
                                        ...
                                        <a className="block sm:inline-block py-4 px-6 text-xs font-semibold leading-none border border-blue-400 hover:border-blue-400 rounded"
                                           href="#">
                                            Purchase
                                        </a>
                                    </div>
                ...
                <section className="py-20 bg-top bg-no-repeat"
