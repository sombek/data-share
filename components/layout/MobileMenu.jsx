                ...
                <nav
                    ...
                    <div>
                        <ul className="mobile-menu">
                            <li className={isActive.key == 1 ? "mb-1 menu-item-has-children rounded-xl active" : "mb-1 menu-item-has-children rounded-xl"}
                                ...
                                <ul className={isActive.key == 1 ? "dropdown pl-5" : "hidden"}>
                                    <li>
                                        <Link href="/index">
                                            <a className="block p-3 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500">Home
                                                1</a>
                                        </Link>
                                    </li>
                                    <li>
                            ...
                            <li className="mb-1 rounded-xl">
                                <Link href="/about">
                                    <a className="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500 rounded-xl">About
                                        Us</a>
                                </Link>
                            </li>
                            <li className="mb-1">
                            ...
                            <li className={isActive.key == 2 ? "mb-1 menu-item-has-children rounded-xl active" : "mb-1 menu-item-has-children rounded-xl"}
                                ...
                                <ul className={isActive.key == 2 ? "dropdown pl-5" : "hidden"}>
                                    <li>
                                        <Link href="/blog">
                                            <a className="block p-3 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500">Category
                                                1</a>
                                        </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <Link href="/blog-single">
                                            <a className="block p-3 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500">Single
                                                1</a>
                                        </Link>
                                    </li>
                                    <li>
                            ...
                            <li className="mb-1">
                                <Link href="/contact">
                                    <a className="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500">Contact
                                        Us</a>
                                </Link>
                            </li>
                        </ul>
                        <div className="mt-4 pt-6 border-t border-blueGray-100">
                            <Link href="/signup">
                                <a className="block px-4 py-3 mb-3 text-xs text-center font-semibold leading-none bg-blue-400 hover:bg-blue-500 text-white rounded">Sign
                                    Up</a>
                            </Link>
                            <Link href="/login">
                                <a className="block px-4 py-3 mb-2 text-xs text-center text-blue-500 hover:text-blue-700 font-semibold leading-none border border-blue-200 hover:border-blue-300 rounded">Log
                                    In</a>
                            </Link>
                        </div>
                    </div>
